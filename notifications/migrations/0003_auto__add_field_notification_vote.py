...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Notification.vote'
        db.add_column(u'notifications_notification', 'vote',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='notifications', null=True, to=orm['review.Vote']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Notification.vote'
        db.delete_column(u'notifications_notification', 'vote_id')
    ...
    models = {
        ...
        u'notifications.notification': {
            ...
            'vote': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'notifications'", 'null': 'True', 'to': u"orm['review.Vote']"})
        },
        u'review.comment': {
